...
},{"./dist/worker/index":"../node_modules/threads/dist/worker/index.js"}],"../node_modules/@canvas/image-data/browser.js":[function(require,module,exports) {
/* eslint-env browser */

module.exports = ImageData

},{}],"../node_modules/resize-image-data/index.js":[function(require,module,exports) {
'use strict';
...
function bilinearInterpolation(src, dst) {
  ...
  function interpolateHorizontal(offset, x, y, xMin, xMax) {
    var vMin = src.data[(y * src.width + xMin) * 4 + offset];
    if (xMin === xMax) return vMin;
    var vMax = src.data[(y * src.width + xMax) * 4 + offset];
    return interpolate(x, xMin, xMax, vMin, vMax);
  }

  function interpolateVertical(offset, x, xMin, xMax, y, yMin, yMax) {
    var vMin = interpolateHorizontal(offset, x, yMin, xMin, xMax);
    if (yMin === yMax) return vMin;
    var vMax = interpolateHorizontal(offset, x, yMax, xMin, xMax);
  ...
  for (var y = 0; y < dst.height; y++) {
    for (var x = 0; x < dst.width; x++) {
      var srcX = x * src.width / dst.width;
      var srcY = y * src.height / dst.height;
      var xMin = Math.floor(srcX);
      var yMin = Math.floor(srcY);
      var xMax = Math.min(Math.ceil(srcX), src.width - 1);
      var yMax = Math.min(Math.ceil(srcY), src.height - 1);
...
module.exports = function resizeImageData(image, width, height, algorithm) {
  ...
  switch (algorithm) {
    ...
    default:
      throw new Error("Unknown algorithm: ".concat(algorithm));
  }
...
},{"@canvas/image-data":"../node_modules/@canvas/image-data/browser.js"}],"worker-kittydar.js":[function(require,module,exports) {
"use strict";
...
var _resizeImageData = _interopRequireDefault(require("resize-image-data"));
...
function getAllSizes(imageData, width, height) {
  var minSize = 48; // starting window size

  var resize = 360; // initial image resize size in px

  var scaleStep = 6; // scaling step size in px
  ...
  for (var size = minSize; size < max; size += scaleStep) {
    var winScale = minSize / size * scale;
    var resizeWidth = Math.floor(width * winScale);
    var resizeHeight = Math.floor(height * winScale);
    var resizedImageData = (0, _resizeImageData.default)(imageData, resizeWidth, resizeHeight);
    resizes.push({
...
/*#__PURE__*/
function () {
  var _handleCatImage = (0, _asyncToGenerator2.default)(
  /*#__PURE__*/
  _regenerator.default.mark(function _callee(objData) {
    var cats, imageData, resizes;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            resizes = getAllSizes(imageData, objData.width, objData.height);
  ...
  function handleCatImage(_x) {
    return _handleCatImage.apply(this, arguments);
  }

  return handleCatImage;
}());
},{"@babel/runtime/regenerator":"../node_modules/@babel/runtime/regenerator/index.js","@babel/runtime/helpers/asyncToGenerator":"../node_modules/@babel/runtime/helpers/asyncToGenerator.js","threads/worker":"../node_modules/threads/worker.js","resize-image-data":"../node_modules/resize-image-data/index.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","worker-kittydar.js"], null)
//# sourceMappingURL=/worker-kittydar.24a59044.js.map